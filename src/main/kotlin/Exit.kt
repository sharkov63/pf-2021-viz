...
/**
 * This component contains exit functions, which print a certain message,
...
fun exitHelp() {
    ...
    println("                        ... [-p PADDING] [-c COLOR] [-s SCALE] [-o OUTPUT_FILE]")
    println("                                                                               ")
    ...
    println("Color can be a hex code, or a word (red, green, purple, etc.)                  ")
    println("                                                                               ")
